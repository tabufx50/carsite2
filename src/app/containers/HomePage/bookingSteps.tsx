...
export function BookingSteps() {
    return <Container>
        ...
        <StepContainer>
            ...
            <StepDescription>Find the nearest Yourcar point to book your car. </StepDescription>
        </StepContainer>
        <StepContainer>
            <Step>
                <StepIcon>
        ...
        <StepContainer>
            ...
            <StepDescription>Book your car with ease with one simple click. </StepDescription>
        </StepContainer>
        </StepsContainer>
    </Container>
}